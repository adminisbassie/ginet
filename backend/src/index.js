  ...
  definition: {
    openapi: "3.0.0",
      info: {
        version: "1.0.0",
        title: "ginet",
        description: "ginet Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
...
app.use('/api/reaction', passport.authenticate('jwt', {session: false}), reactionRoutes);
