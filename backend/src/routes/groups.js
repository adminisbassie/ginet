...
router.post('/', async (req, res) => {
    await GroupsService.create(req.body.data, req.currentUser, true, req.headers.referer);
    const payload = true;
...
router.get('/', wrapAsync(async (req, res) => {
  const payload = await GroupsDBApi.findAll(
    req.query,
  );
...
router.get('/:id', wrapAsync(async (req, res) => {
  const payload = await GroupsDBApi.findBy(
    { id: req.params.id },
  );
